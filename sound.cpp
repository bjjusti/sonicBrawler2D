  ...
  channels() 
{
  ...
  music = Mix_LoadMUS("sound/city_escape.mp3");
  ...
  sounds.push_back( Mix_LoadWAV("sound/special.wav") );
  sounds.push_back( Mix_LoadWAV("sound/power.wav") );
...
void SDLSound::switchMusic() {
  Mix_HaltMusic();
  Mix_FreeMusic(music);
  music = Mix_LoadMUS("sound/sonic_boom.mp3");
  startMusic();
