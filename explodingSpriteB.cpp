...
ExplodingSpriteB::ExplodingSpriteB(const Boss& s) :
  Boss(s), 
  chunks(), 
  freeList(){
  makeChunks(
...
ExplodingSpriteB::~ExplodingSpriteB() { 
...
void ExplodingSpriteB::draw() const { 
...
void ExplodingSpriteB::update(Uint32 ticks) { 
...
void ExplodingSpriteB::makeChunks(unsigned int n) { 
